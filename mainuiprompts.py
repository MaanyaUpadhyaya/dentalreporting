...
def region_table_prompts(is_pterygoid):
    ...
    if region_numbers == "":
        ...
        if not all_valid:
                print("\n Invalid region numbers. Please enter a valid FDI teeth number.")
...
def prompt_num_of_implants():
    ...
    implants = int(implants) if implants.isdigit() else 0
    if implants > 60:
        print("Error in number of implants entered. Please check.")
        exit()
    return implants
